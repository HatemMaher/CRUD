...
}, _a.locationVisitKey = "inertiaLocationVisit", _a);
...
function isNamedLayouts(value, isComponent2) {
  if (!isPlainObject3(value) || isComponent2(value) || "component" in value) {
    return false;
  }
...
function isPropsObject(value, isComponent2) {
  return isPlainObject3(value) && !isComponent2(value) && !("component" in value) && !isNamedLayouts(value, isComponent2);
}
    ...
    return () => {
      if (component.value) {
        ...
        if (typeof layoutValue === "function" && layoutValue.length <= 1 && typeof layoutValue.prototype === "undefined") {
          ...
          if (isPropsObject(result2, isComponent)) {
  ...
  const submit = async (method2, url, options) => {
    ...
    try {
      ...
      if (response.status >= 200 && response.status < 300) {
        ...
        (_d = options.onSuccess) == null ? void 0 : _d.call(options, responseData);
        if (!wasDefaultsCalledInOnSuccess()) {
          setDefaults(cloneDeep(form.data()));
        }
        form.isDirty = false;
      ...
      if (error instanceof HttpCancelledError2 || error instanceof Error && error.name === "AbortError") {
        (_f = options.onCancel) == null ? void 0 : _f.call(options);
      ...
      (_g = options.onFinish) == null ? void 0 : _g.call(options);
    }
  };
